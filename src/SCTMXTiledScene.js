...
var SCTileLayer = cc.Layer.extend({
    ...
    onEnter:function () {
       ...
       this.synth.init();
    	...
    	/*var animFrames = [];
			     var frame1 = cc.TextureCache.getInstance().addImage(s_CircleA1);
			     var frame2 = cc.TextureCache.getInstance().addImage(s_CircleA2);
			     var frame3 = cc.TextureCache.getInstance().addImage(s_CircleA3);
			     var frame4 = cc.TextureCache.getInstance().addImage(s_CircleA4);
			     var frame5 = cc.TextureCache.getInstance().addImage(s_CircleA5);
			     var frame6 = cc.TextureCache.getInstance().addImage(s_CircleA6);
			     var frame7 = cc.TextureCache.getInstance().addImage(s_CircleA7);
			    ...
			    /*
			     ...
			     tempSprite.setPosition(cc.p(250,250));
			    ...
			    /*  var animation = cc.Animation.create();
			     ...
			     tempSprite.setPosition(cc.p(700,400));
